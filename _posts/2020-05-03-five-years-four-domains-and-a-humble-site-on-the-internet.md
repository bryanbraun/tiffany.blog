---
title: "Five Years, Four Domains, and a Humble Site on the Internet"
date: 2020-05-03
layout: post
categories:
  - Site Stuff
tags:
  - anniversary
image:
  path: https://res.cloudinary.com/thatmacnerd/image/upload/v1588019276/tmn.png
  caption: That Mac Nerd, the penultimate iteration of this blog
excerpt: Started out with big ambitions, ended up with just me.
description: Started out with big ambitions, ended up with just me.
---
...
- Mac & iOS Tips for Non-Traditional Students
- The Class Apple Nerd
- That Apple Nerd
- That Mac Nerd
- ...to tiffany.blog
...
*Non-traditional students who love Apple devices* was about as niche as you could get. After someone pointed out to me how stilted the name sounded and how bad the URL was[^1] I decided I'd switch it up. 
...
First, there was *The Class Mac Nerd*[^2]. I copied everything, even the little Happy Mac icon:

<figure>
    <img class="align-center" src="https://res.cloudinary.com/thatmacnerd/image/upload/v1588484187/happy-mac.png" />
    <figcaption style="text-align: center; margin-top: -1.3em;">
       I mean look at this little guy
       <a href="https://res.cloudinary.com/thatmacnerd/image/upload/v1588484187/happy-mac.png">
...
It became all too much. So much so that I [quit the blog entirely](/2019/04/01/moving-on-for-now/) though that only lasted [a couple months](/2019/06/01/back-but-with-caveats/). After hopping over to [micro.blog](https://micro.blog) and getting into the [IndieWeb](https://indieweb.org/) did I know what I wanted for this blog: *a place to talk about whatever I want*. End of.
...
[^1]: http://nontradmacstudent.co I think it was.
[^2]: Now, the site is just [The Class Nerd](https://www.theclassnerd.com/).
