...
As you have probably noticed, I have added *Sections* to the site in the main navigation area. This is taking a cue from [MacStories](https://www.macstories.net/) only I don't have a developer working with me on the site and so I have tried to work on the PHP backend a bit and added a few plugins to achieve this.
...
[^1]: Having [my setup featured on The Sweet Setup also helped](http://thesweetsetup.com/tiffany-whites-mac-ios-setup/). A lot.
...
[^5]: Every month I will review something I have bought, an app, a piece of kit, or something else interesting that I may want to write about. Nod to [Tim Nahumck](https://nahumck.me/category/piques-of-the-week/) for this idea.
