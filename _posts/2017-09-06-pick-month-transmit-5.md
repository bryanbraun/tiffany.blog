...
post_name: pick-month-transmit-5
...
I had used that app for a while when I heard about their FTP client, Transmit 4. I waited a while to buy it; it was $40 or so [^3]. I enjoyed using Transmit but the interface was outdated. Some key functionality wasn’t there but it was a great *FTP* app. You could connect it to your servers, Coda, and Amazon S3 and the like. You could also sync settings between your Macs with [Panic Sync](https://panic.com/sync/). It was good at what it did even if it was long in the tooth.
...
[^2]: I find it hard to read books on my Mac but it still thrilled me nonetheless.
[^3]: Coda 2 was $75 so I was trying not to blow all my money at once.